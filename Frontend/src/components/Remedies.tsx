...
const NPKDashboard = () => {
  ...
  const fetchYouTubeVideos = async () => {
    ...
    setTimeout(() => {
      ...
      setVideos([
        { id: 1, title: "How to Fix Low Phosphorus in Soil Naturally", thumbnail: "/api/placeholder/320/180", views: "245K" },
        { id: 2, title: "Balancing NPK Values for Optimal Plant Growth", thumbnail: "/api/placeholder/320/180", views: "178K" },
        { id: 3, title: "Organic Solutions for Phosphorus Deficiency", thumbnail: "/api/placeholder/320/180", views: "92K" },
        { id: 4, title: "Understanding NPK Ratios in Fertilizers", thumbnail: "/api/placeholder/320/180", views: "320K" },
        { id: 5, title: "Best Phosphorus Fertilizers for Garden Plants", thumbnail: "/api/placeholder/320/180", views: "105K" },
        { id: 6, title: "Symptoms of Phosphorus Deficiency in Plants", thumbnail: "/api/placeholder/320/180", views: "87K" },
        { id: 7, title: "How to Test and Adjust Soil NPK Levels", thumbnail: "/api/placeholder/320/180", views: "201K" },
        { id: 8, title: "High Potassium Soils: Problems and Solutions", thumbnail: "/api/placeholder/320/180", views: "76K" },
        { id: 9, title: "DIY Phosphorus-Rich Fertilizers at Home", thumbnail: "/api/placeholder/320/180", views: "135K" },
        { id: 10, title: "Complete Guide to NPK Management", thumbnail: "/api/placeholder/320/180", views: "256K" }
      ]);
